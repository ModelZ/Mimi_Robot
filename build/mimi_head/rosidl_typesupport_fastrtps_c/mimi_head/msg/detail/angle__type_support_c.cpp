...
#include "mimi_head/msg/detail/angle__rosidl_typesupport_fastrtps_c.h"
...
using _Angle__ros_msg_type = mimi_head__msg__Angle;
...
static uint32_t _Angle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mimi_head__msg__Angle(
...
static size_t _Angle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mimi_head__msg__Angle(
