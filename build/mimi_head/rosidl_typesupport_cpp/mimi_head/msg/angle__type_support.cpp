...
static const _Angle_type_support_symbol_names_t _Angle_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mimi_head, msg, Angle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mimi_head, msg, Angle)),
  }
};
...
{
  return &::mimi_head::msg::rosidl_typesupport_cpp::Angle_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mimi_head, msg, Angle)() {
  return get_message_type_support_handle<mimi_head::msg::Angle>();
}
